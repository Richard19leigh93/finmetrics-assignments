...
# 3. Plot all the cumulative returns for the 
# Financials indexes of the three countries -
# whose Financials index outperformed?
...
# 4. Calculate the JALSH index returns, 
# by filtering the top 95% of Market Cap. 
