...
Some of the code is messy and I'm not sure whether on the right track. Surely there is an easier way.
...
![Cap-weighted returns by sector by country](https://github.com/JannesRed/finmetrics-assignments/blob/master/Index_Return_Comparison/bin/Cap_Weighted_monthly_JALSHAll.png)
